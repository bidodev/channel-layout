...
document.querySelector(".btn-light").addEventListener("click", function () {
  ...
  var mainItems = document.querySelectorAll(".header, .main-page__sidebar, .header__search-input, .featured__videos"); //console.log(list);
  ...
  var otherItems = document.querySelectorAll(".inner-profile__info, .inner-nav"); //console.log(list);

  otherItems.forEach(function (element) {
    element.classList.toggle("grey-light");
  }); //text-black

  var a = document.querySelectorAll(".inner-profile__name-cont, .inner-content__text-3, .inner-content__text-1, .inner-content__text-2, .inner-content__text-4, .channel__info--name"); //console.log(list);
  ...
  document.querySelector(".featured-channels__title").classList.toggle("text-dark-featured"); //sidebar elements

  var sidebarItem = document.querySelectorAll(".main-page__sidebar-item");
  sidebarItem.forEach(function (element) {
